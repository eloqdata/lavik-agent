...
export const manualReviewedPaths = () =>
  [
    ...
    "apps/web/components/benchmark.tsx",
    "apps/web/public/_redirects",
    "apps/web/public/robots.txt",
    "apps/worker/index.ts",
    "wrangler.jsonc",
    "packages/seo/site.ts",
    "packages/seo/dates.ts",
    "packages/marketing/analytics.ts",
    "packages/marketing/attribution.ts",
    "packages/marketing/report.ts",
    "packages/marketing/schedule.ts",
    "policies/marketing-schedule.json",
    "content/discovery.json",
    "scripts/build-discovery.ts",
    "scripts/audit-seo.py",
    "scripts/notify-indexnow.ts",
    "scripts/marketing.ts",
    "scripts/blog-task.ts",
    "scripts/install-marketing.ts",
    "scripts/verify-publication.ts",
    "scripts/review-site.ts",
    "tests/marketing.test.ts",
    "tests/seo.test.ts",
    "tests/browser/discovery.spec.ts",
    "docs/marketing-operations.md",
    ...
    "packages/admin/auth.ts",
    "packages/admin/store.ts",
    "packages/admin/dispatch.ts",
    ...
    "apps/web/components/use-cases.css",
    "packages/agents/workflow.ts",
    "tests/publication-fixture.ts",
    ".gitignore",
    "packages/local/review-packet.ts",
    "scripts/seo_html.py",
    "scripts/verify_site.py",
    "tests/seo_deployment.py",
    "tests/seo-deployment.test.ts",
    ...
    "tests/admin.test.ts",
    "tests/browser/blog-series.spec.ts",
    "tests/browser/use-cases.spec.ts",
    "tests/community.test.ts",
    "tests/content.test.ts",
    "tests/downloads.test.ts",
    "tests/marketing-deployment.test.ts",
    "tests/openai.test.ts",
    "tests/publication.test.ts",
    "tests/workflow.test.ts",
    "packages/admin/execute.ts",
    "packages/agents/config.ts",
    "packages/agents/openai.ts",
    "tests/admin-browser/admin.spec.ts",
    "package.json",
    "package-lock.json",
    "tsconfig.json",
